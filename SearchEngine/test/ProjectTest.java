...
public class ProjectTest {
    ...
    public static final String THREAD_FLAG = "-t";
    public static final String PORT_FLAG   = "-p";

    public static final String INDEX_DEFAULT  = "index.txt";
    public static final String SEARCH_DEFAULT = "search.txt";
	...
	public static boolean isEnvironmentSetup() {
		...
		Path query  = Paths.get(QUERY_DIR);
