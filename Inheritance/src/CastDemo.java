...
public class CastDemo {
	...
	/**
	 * This method demonstrates simple upcasting and downcasting. Note
	 * that even though {@link Number} is an abstract class, we can still
	...
	/**
	 * This method demonstrates one possible use for upcasting---getting
	 * around the restriction that arrays must have the same type.
	 */
	...
	/**
	 * This method demonstrates that since every class implicitly inherits
	 * from {@link Object}, we can always upcast to the {@link Object} class.
	 */
	...
	/**
	 * This method demonstrates that we can also do this if the classes
	...
	/**
	 * This method is part of the {@link #interfaceDemo()} example, and
	 * shows how generalized methods can be created that will work on
	 * multiple subclasses.
	 *
	...
	/**
	 * This method runs all of the examples at once. You can comment
	 * out each demo to run one at a time if you want.
	 *
	 * @param args unused
	 */
