...
public class ShapeDemo {
	...
	/**
	 * Displays basic information about the shape, including the class
	 * name, hash code, type, String representation, and area. Uses casting
	 * so that one method can be provided for any type of Shape object.
	 *
